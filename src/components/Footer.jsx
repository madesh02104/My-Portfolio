  ...
  return (
    <section>
      <section className="bg-emerald-600 w-full pt-6 rounded-t-2xl flex flex-col justify-center items-center gap-6">
        <p className="text-white  font-semibold text-md sm:text-2xl">
          Learning today and making one step at a time.
        </p>
        <div className="w-fit flex gap-8 mb-4">
          <a href="https://github.com/madesh02104" target="_blank">
            {" "}
            <FaGithub size={32} />
          </a>
          <a href="https://x.com/madesh02104" target="_blank">
            {" "}
            <FaTwitter size={32} />
          </a>
